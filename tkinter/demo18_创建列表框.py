...
tk.Label(a1,text='员工列表:  ',font=('楷体',20)).place(x=3,y=5)
#  创建列表框 
lb = tk.Listbox(a1,font=('楷体',15),width=65,height=18)
lb.place(x=19,y=50)
...
def t():
    ...
    def tj():
        ...
        nei = f'城市：{t2.get()},性别: {s2.get()},爱好: '+ai
        #  在列表框内中追加内容  （ 内容只能是字符串形式 ）
        lb.insert(END,nei)
